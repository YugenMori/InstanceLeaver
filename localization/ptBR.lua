local L = LibStub("AceLocale-3.0"):NewLocale("InstanceLeaver", "ptBR")
...
L["Art & Themes"] = "Arte & Temas"
L["Colorization"] = "Colorização"
L["Tweaks & Extra"] = "Ajustes & Extras"
L["Scale & Frame Size"] = "Escala & Tamanhos" 
L["Thanks & Translations"] = "Agradecimentos & Traduções"
-- Daily Info
...
L["Smooth Camera (90% Slower)"] = "Câmera Suave (90% Lenta)"
L["Makes the Camera turns in a more smooth way"] = "Faz a câmera virar de uma forma mais suave"
L["|cfff2dc7fAuto Repair/Sell Gray Items|r"] = "|cfff2dc7fVender Cinza e Reparar automático|r"
L["When you open a Merchant shop, auto sell gray"..
" and repair items"] = "Quando você abre o ferreiro, vende itens cinza e repara os itens automaticamente"
L["Auto Gamma"] = "Gamma Automática"
...
L["Non-Military Date/Time"] = "Formato de Data/Hora não militar"
L["Change the date format of the whole UI to"..
" Non-Military format"] = "Muda o formato da data da interface para o formato não militar"
L["RPG chat fonts"] = "Chat Fonte RPG"
L["Change the chat fonts to a RPG look-alike style"] = "Muda a fonte do chat para um estilo RPG"
L["Auto Screenshot"] = "Screenshot Automática"
L["Automatically takes a screenshot when you level up"] = "Tira uma foto toda vez que você ganha level"
L["Transparent Name BKGD"] = "Fundo Transparente (Nome)"
L["Remove any color in the target name background"] = "Remove qualquer cor de fundo no nome do alvo"
L["Default Class Background"] = "Fundo Padrão de Classe"
L["Remove the class color background behind"..
" the player names to default values (Transparent Name needs to be unchecked)"] = "Remove a cor de classe de fundo"..
...
"go to Textures->font and replace the file keeping the same name"] = "Irá remover qualquer mudança na fonte de dano"..
"\n *Você precisa re-iniciar o jogo para que a fonte seja recarregada. Você pode também trocar ela, "..
"vá para Textures->font e troque o arquivo mantendo o mesmo nome"
L["|cfff2dc7fDisable Portrait Text Spam|r"] = "|cfff2dc7fDesativar Texto Spam Retrato|r"
L["Disable healing/damage spam over player"..
" and pet portraits"] = "Desativa o spam de cura/dano no retrato de pet e jogador"
L["Disable New Minimap"] = "Desativa Novo Minimapa"
L["This option will get you back to the"..
" Blizzard default minimap style (round)."] = "Irá voltar o minimapa para o padrão da Blizzard (redondo)"
L["Disable Smoke Texture"] = "Desativa Textura Fumaça"
L["It will disable the 'smoke' texture around the portrait in "..
"the UnitFrameImproved version of it"] = "Irá desativar a textura de 'fumaça' em volta dos retratos na versão "..
" UnitFrameImproved"
...
L["Silence Kill Announcer"] = "Silenciar Kill Announcer"
L["Remove boss/kill sounds from the Kill Announcer frame"] = "Remove os sons de chefes/morte do Kill Announcer"
L["|cfff2dc7fTooltip on Cursor|r"] = "|cfff2dc7fTooltip no Ponteiro|r"
L["Tooltips will appear close to the mouse cursor position"] = "Toolips vão aparecer perto do ponteiro do mouse"
L["|cfff2dc7fInspect Target (Shift + ')|r"] = "|cfff2dc7fInspecionar Alvo (Shift + ')|r"
L["When you have a target or your mouse is over someone character,"..
" to inspect this player press the keys Shift + '"] = "Quando você tem um alvo ou o mouse está sobre um personagem,"..
" para inspecionar esse jogador pressione as teclas Shift+'"
L["|cfff2dc7fConfirm Pop-Ups (Ctrl + ')|r"] = "|cfff2dc7fConfirmar Pop-Ups (Ctrl + ')|r"
L["When this is active you can confirm almost"..
" any pop-ups (release, quests, stacks, etc) pressing the keys Ctrl + '"] = "Quando ativo, você pode confirmar quase"..
" todos os pop-ups (liberar, missões, stacks, etc) pressionando as teclas Ctrl + '"
L["First Person View"] = "Visão Primeira Pessoa"
L["Change the camera view to a 'First Person' experience"] = "Muda a visão da câmera para primeira pessoa"
L["ActionButton on KeyUp"] = "Ações Tecla Liberada"
L["With this option spells can be cast just when the"..
" keybind are released"] = "Com essa opção magias podem ser castadas apenas quando a tecla é solta"
L["Combat Cursor Mode"] = "Modo de Combate"
L["Makes the camera turns with your mouse when in"..
" combat (right-click to show cursor)"] = "Faz a câmera virar com o mouse quando em combate (botão direito mostra ponteiro)"
L["Square Minimap"] = "Minimapa Quadrado"
L["A modern minimap (neon class borders)"] = "Um minimapa moderno (bordas neon com cor da classe)"
L["Keep UnitFrame Dark"] = "Manter UnitFrame Escuro"
L["Even if you change theme, this will keep UnitFrame Dark"..
" (player frame, boss, etc)."] = "Mesmo mudando de tema, esta opção irá manter o UnitFrame escuro"..
" (frame jogador, chefes, etc)"
L["You can only select one style of UnitFrame color"] = "Você pode apenas selecionar um estilo de Cor para o UnitFrame"
L["Keep UnitFrame Blizzard Like"] = "Manter UniFrame Blizzard"
L["Even if you change theme, this will keep UnitFrame"..
" Blizzard like (player frame, boss, etc)."] = "Mesmo mudando de tema, esta opção irá manter o tema clássico da Blizzard"..
" (frame jogador, chefes, etc)"
L["|cfff2dc7fInstance Leave Frame|r"] = "|cfff2dc7fSair Instâncias (Frame)|r"
L["A dynamic frame that pop-up when you"..
" complete a LFG (dungeon, raid, etc)"] = "Um frame que aparece quando você completa uma LFG (dungeon, raid, etc)"
L["Minimalist UI"] = "Interface Minimalista"
L["Hide some parts of the UI when you are out of combat ('ATL-CTRL-P' to show frames)"] = "Esconde parte da Interface"..
" quando você está fora de combate ('ATL-CTRL-P' para mostrar os frames)"
L["Disable 'Dynamic Quest Tracker' at Miscellaneous tab first"] = "Primeiro desative 'Missões Dinâmicas' na aba Diversos"
...
L["Default"] = "Padrão"
L["Need Translator"] = "Precisa de Tradutor"
...
L["Green Health Bars"] = "Barras de Vida Verde"
L["All unitframe health bars will be green (default)"] = "Todas as barras de vida da unitframe serão verdes (padrão)"
L["Not available in this version of WoW!"] = "Não disponível nesta versão do WoW!"
L["In this tab of the addon settings, you will find options directed to the version of WoW Classic."..
" Many of them are exclusive and can only be used in Burning Crusade and similar client versions."] = "Nesta aba das configurações do addon, você encontrará opções direcionadas a versão do WoW Classic."..
" Muitas delas são exclusivas e só podem ser usadas no Burning Crusade e versões do cliente semelhantes."
L["|cffb62a25In development, more features will be added soon, so be patient.|r"] = "Em desenvolvimento, mais funções serão adicionadas em breve, seja paciente."
L["Hide Helm"] = "Esconder o Elmo"
L["Hide the player helm"] = "Esconder o elmo do jogador"
L["Hide Cloak"] = "Esconder a capa"
L["Hide the player cloak"] = "Esconda a capa do jogador"
L["Better World Map"] = "Mapa do Mundo Melhorado"
L["Makes the worldmap minimalist/clean"] = "Torna o mapa do mundo minimalista / bonito"
L["World Map Fader"] = "Transpârencia do Mapa Mundial"
L["Makes the worldmap fade while you move"] = "Faz com que o mapa mundial fique transparente enquanto você se move"
L["Default Nameplate Range"] = "Distância padrão Nameplates"
...
L["Flat HealthBars"] = "Barras de vida Flat"
L["Make the health bar textures looks Flat"] = "Faz as texturas da barra de saúde parecerem Flat(plana)"
L["Show Minimap Clock"] = "Relógio Minimapa"
L["This will always show the minimap clock, instead of showing on hover"] = "Isso sempre mostrará o relógio do minimapa, em vez de mostrar só ao passar o mouse"
L["Buy me a coffee: |cffffcc00patreon.com/yugensan|r"] = "Me paga um café: |cffffcc00patreon.com/yugensan|r"
L["|cfff2dc7fBuy me a coffee!|r"] = "|cfff2dc7fCompre-me um café!|r"
L["Class Color"] = "Cor da Classe"
L["Change icon border to a class colored theme"] = "Alterar a borda do ícone para um tema colorido da classe"
L["You need to select just one of those options so they don't overlap"] = "Você precisa selecionar apenas uma dessas opções para que não se sobreponham"
L["Crisp"] = "Nítido"
L["Change icon border to a crisp theme"] = "Alterar a borda do ícone para um tema nítido"
L["Original"] = "Original"
L["Change icon border to a original theme"] = "Alterar a borda do ícone para um tema original"
L["Square"] = "Quadrado"
L["Change icon border to a square theme"] = "Alterar a borda do ícone para um tema quadrado"
L["Thin"] = "Fino"
L["Change icon border to a thin theme"] = "Alterar a borda do ícone para um tema fino"
L["Glass"] = "Vidro"
L["Change the icon to a glass theme"] = "Alterar a borda do ícone para um tema de vidro"
	L["Default QuestFrame"] = "QuestFrame padrão"
L["Disable QuestFrame border and text colorization to default from Blizzard"] = "Desativar a borda do frame de quests e a colorização de texto para o padrão da Blizzard"
L["|cfff2dc7fLortUI|r for better icon borders and shadows."] = "|cfff2dc7fLortUI|r para melhores bordas e sombras de ícones."
L["|cff0d75d4Frequently Answered Questions|r"] = "|cff0d75d4Perguntas respondidas com freqüência|r"
L["Always check the FAQ before posting. Bug reports have more visibility on our discord channel."] = "Sempre verifique o FAQ antes de postar. Relatórios de bugs têm mais visibilidade em nosso canal de discord."
L["- How to change fonts or go back to Bliizard default?\n"..
"A: Go to AbyssUI folder -> textures -> font and change the fonts keeping their names (you need to restart the game)."] = "- Como alterar as fontes ou voltar ao padrão da Blizzard?\n"..
"R: Vá para a pasta AbyssUI -> texturas -> fonte e mude as fontes mantendo seus nomes (você precisa reiniciar o jogo)."
L["- Do you plan to add save profiles to the UI?\n"..
"A: No, at least it's not on my plans right now. At this point, the interface have so many options and I have short time to work on it, so it's not planned."] = "- Você planeja adicionar perfis salvos à UI?\n"..
"R: Não, pelo menos não está nos meus planos agora. Neste ponto, a interface tem tantas opções e tenho pouco tempo para trabalhar nela, então não planejo no momento."
L["- Some texture are looking/acting weird or Texture/Image is not right or cropped?\n"..
"A: You are probably using a old version of AbyssUI, try a fresh installation, delete the old version and re-download it."] = "- Alguma textura está parecendo/agindo de maneira estranha ou a textura/imagem não está correta ou cortada?\n"..
"R: Você provavelmente está usando uma versão antiga do AbyssUI, tente uma nova instalação, exclua a versão antiga e baixe-a novamente."
...
L["|cfff2dc7fMy Patreon, it's related to all my projects, so keep this in mind. You will be helping a lot of projects at once! Confirm to get the link|r"] = "|cfff2dc7fMeu Patreon, está relacionado a todos os meus projetos, então tenha isso em mente. Você estará ajudando muitos projetos de uma vez! Confirme para obter o link|r" 
L["|cfff2dc7fDonations will appear in the 'Donators' tab as a rank. Thank you very much, confirm to get the link|r"] = "|cfff2dc7fDoações aparecerá na guia 'Doadores' como uma classificação. Muito obrigado, confirme para obter o link|r"
L["Dragonflight UnitFrame"] = true
L["Reverse HealthBar Fill"] = "Barra de Vida Reversa"
L["All unitframe health bars will fill in reverse"] = "Reverte o enchimento de todas as barras de vidas"
